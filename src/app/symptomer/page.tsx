            ...
            {symptoms.map((s, i) => (
              ...
              >
                <button
                  ...
                  className="w-full text-left bg-white rounded-2xl p-8 border border-[var(--color-emerald-100)] hover:border-[var(--color-emerald-300)] transition-all duration-300 hover:shadow-lg hover:shadow-emerald-600/5 group"
                >
