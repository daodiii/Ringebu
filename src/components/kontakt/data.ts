...
export const KONTAKT = {
  ...
  email: { display: "post@ringebutannlegesenter.no", href: "mailto:post@ringebutannlegesenter.no" },
  address: { display: "Jernbanegata 4, 2630 Ringebu", short: "Jernbanegata 4", href: MAPS_SEARCH },
  akutt: {
...
export const HOURS: HourRow[] = [
  ...
  { day: "Tirsdag", code: "Tir", hours: "08:30 – 18:00" },
  { day: "Onsdag", code: "Ons", hours: "08:00 – 15:00" },
  { day: "Torsdag", code: "Tor", hours: "09:00 – 18:00" },
  { day: "Fredag", code: "Fre", hours: "08:00 – 15:00" },
